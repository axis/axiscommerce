...
class Axis_PaymentCheckMoney_Upgrade_0_1_0 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        Axis::single('core/config_field')
            ...
            ->add('payment/CheckMoney_Standard/enabled',       'Payment Methods/Check & Money Order/Enabled', '0', 'bool', '', array('model'=> 'Axis_Core_Model_Config_Value_Boolean', 'translation_module' => 'Axis_Core'))
            ->add('payment/CheckMoney_Standard/title',         'Title', 'Check & Money Order', 'string', 'Title')
            ->add('payment/CheckMoney_Standard/geozone',       'Allowed Payment Zone', '1', 'select', 'Payment method will be available only for selected zone', array('model' => 'Axis_Location_Model_Geozone', 'translation_module' => 'Axis_Admin'))
            ->add('payment/CheckMoney_Standard/sortOrder',     'Sort Order', '1', 'string', array('translation_module' => 'Axis_Core'))
            ->add('payment/CheckMoney_Standard/orderStatusId', 'Order Status on payment complete', '1', 'select', 'Set the status of orders made with this payment module to this value', array('model' => 'Axis_Sales_Model_Order_Status', 'translation_module' => 'Axis_Admin'))
            ...
            ->add('payment/CheckMoney_Standard/shippings',     'Disallowed Shippings', '0', 'multiple', 'Selected shipping methods will be not available with this payment method', array('model' => 'Axis_Checkout_Model_Shipping', 'translation_module' => 'Axis_Admin'));
    }
