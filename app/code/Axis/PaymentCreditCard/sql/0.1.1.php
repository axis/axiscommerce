...
class Axis_PaymentCreditCard_Upgrade_0_1_1 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        Axis::single('core/config_field')
            ...
            ->add('payment/CreditCard_Standard/enabled', 'Enabled', 0, 'radio', '', array('model'=> 'Axis_Core_Model_Option_Boolean', 'translation_module' => 'Axis_Core'))
            ...
            ->add('payment/CreditCard_Standard/enabledCvv', 'Accept verification code', '1', 'radio', '', array('model'=> 'Axis_Core_Model_Option_Boolean', 'translation_module' => 'Axis_Admin'))
            ->add('payment/CreditCard_Standard/saveCvv', 'Save verification code', '0', 'radio', 'Do you want to save cvv code?', array('model'=> 'Axis_Core_Model_Option_Boolean', 'translation_module' => 'Axis_Admin'))
