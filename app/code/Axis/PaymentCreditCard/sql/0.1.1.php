...
class Axis_PaymentCreditCard_Upgrade_0_1_1 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        Axis::single('core/config_field')
            ...
            ->add('payment/CreditCard_Standard/enabled', 'Enabled', 0, 'bool', '', array('model'=> 'Axis_Core_Model_Config_Value_Boolean', 'translation_module' => 'Axis_Core'))
            ...
            ->add('payment/CreditCard_Standard/orderStatusId', 'Order Status on payment complete', '1', 'select', 'Set the status of orders made with this payment module to this value', array('model' => 'Axis_Sales_Model_Order_Status', 'translation_module' => 'Axis_Admin'))
            ->add('payment/CreditCard_Standard/enabledCvv', 'Accept verification code', '1', 'bool', '', array('model'=> 'Axis_Core_Model_Config_Value_Boolean', 'translation_module' => 'Axis_Admin'))
            ->add('payment/CreditCard_Standard/saveCvv', 'Save verification code', '0', 'bool', 'Do you want to save cvv code?', array('model'=> 'Axis_Core_Model_Config_Value_Boolean', 'translation_module' => 'Axis_Admin'))
