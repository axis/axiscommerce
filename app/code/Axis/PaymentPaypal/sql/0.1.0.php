        ...
        Axis::single('core/config_builder')
            ->container('payment', 'Payment Methods')
                ...
                ->container('Paypal_Standard', 'PayPal Standard')
                    ...
                    ->option('sandboxMode', 'Sandbox Mode', 1)
                        ->setType('radio')
                ...
                ->container('Paypal_Direct', 'Paypal Direct')
                    ...
                    ->option('saveCvv', 'Save verification code')
                        ...
                        ->setTranslation('Axis_Admin')
                    ->option('server', 'Live or Sandbox', 'sandbox')
                        ->setType('select')
                    ...
                    ->option('mode', 'PayPal Api Mode', 'nvp')
                        ->setType('select')
