...
class Axis_Account_Upgrade_0_2_2 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        ...
        Axis::model('admin/acl_resource')
            ->add('admin/account', 'Manage Accounts')
            ->add('admin/account/customers', 'Manage Customers')
            ...
            ->add('admin/account/group', 'Customer Groups')
            ...
            ->add('admin/account/value-set', 'Account Field Valueset')
            ...
            ->add('admin/account/value-set-value', 'Account Field Valueset Values')
