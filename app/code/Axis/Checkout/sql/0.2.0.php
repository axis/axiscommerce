...
class Axis_Checkout_Upgrade_0_2_0 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        Axis::single('core/config_field')
            ...
            ->add('checkout/address_form/custom_fields_display_mode', 'Checkout/Address Form/Display Mode for Custom Fields', Axis_Checkout_Model_Option_Form_Address_CustomFieldsDisplayMode::getConfigOptionDeafultValue(), 'select', array('model' => 'Axis_Checkout_Model_Option_Form_Address_CustomFieldsDisplayMode'))
            ->add('checkout/address_form/shipping_address_enabled', 'Display Shipping Address', 1, 'bool', '', array('model'=> 'Axis_Core_Model_Option_Boolean'))
            ...
            ->add('checkout/default_values/payment_method', 'Payment Method', 'CashOnDelivery_Standard', 'select', array('model' => 'Axis_Checkout_Model_Option_Payment'));
    }
}