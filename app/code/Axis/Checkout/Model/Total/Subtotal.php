 ...
 */
class Axis_Checkout_Model_Total_Subtotal extends Axis_Checkout_Model_Total_Abstract
{
    protected $_code = 'subtotal';
    protected $_title = 'Subtotal';
    ...
    public function collect(Axis_Checkout_Model_Total $total)
    {
        $total->addCollect(array(
            'code'  => $this->getCode(),
            'title' => $this->getTitle(),
            'total' => Axis::single('checkout/cart')->getTotalPrice(),
