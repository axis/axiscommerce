...
class Axis_GoogleBase_Upgrade_0_1_0 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        Axis::single('core/config_field')
            ...
            ->add('gbase/main/payment', 'Google Base/General/Payment', Axis_GoogleBase_Model_Option_Payment::getConfigOptionDeafultValue(), 'multiple', 'Let your customers buy with all major credit cards', array('model' => 'Axis_GoogleBase_Model_Option_Payment'))
