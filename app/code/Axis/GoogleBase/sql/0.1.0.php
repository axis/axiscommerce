...
class Axis_GoogleBase_Upgrade_0_1_0 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        Axis::single('core/config_field')
            ...
            ->add('gbase/main/dryRun', 'dryRun', '0', 'radio', "Set 'Yes' for testing, 'No' for production", array('model'=> 'Axis_Core_Model_Option_Boolean'))
            ...
            ->add('gbase/auth/login', 'Login', '', 'text', 'Your google account to submit products', array('model' => 'Axis_Core_Model_Option_Crypt'))
            ->add('gbase/auth/password', 'Password', '', 'text', 'Password to google account', array('model' => 'Axis_Core_Model_Option_Crypt'))
            ->add('gbase/auth/connection', 'Connection type', Axis_GoogleBase_Model_Option_ConnectionType::AUTH_SUB, 'select', 'Login type. For ClientLogin fill login and password fields. For AuthSub you will have to enter login and password manually', array('model' => 'Axis_GoogleBase_Model_Option_ConnectionType'));
