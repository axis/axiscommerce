...
class Axis_GoogleBase_Upgrade_0_1_0 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        Axis::single('core/config_builder')
            ->container('gbase', 'Google Base')
                ->setTranslation('Axis_GoogleBase')
                ->container('main', 'General')
                    ->option('payment', 'Payment', 'Discover,American Express,VISA,MasterCard,Wire transfer,Check,Cash')
                        ->setType('multiple')
                    ...
                    ->option('link', 'Link products to', 'Website')
                        ->setType('select')
                ...
                ->container('auth', 'Login')
                    ...
                    ->option('password', 'Password')
                        ...
                        ->setModel('core/option_crypt')
                    ->option('connection', 'Connection type', 'AuthSub')
                        ->setType('select')
