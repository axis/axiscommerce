...
class Axis_Sitemap_Upgrade_0_1_0 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        ...
        Axis::single('core/config_field')
            ...
            ->add('sitemap/main/enabled', 'Sitemap/General/Enabled', '0', 'bool', 'Enabled', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ...
            ->add('sitemap/cms/showPages', 'Show pages', '1', 'bool', 'Show pages on sitemap page', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'));
