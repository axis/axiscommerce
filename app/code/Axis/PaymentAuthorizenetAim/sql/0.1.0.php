...
class Axis_PaymentAuthorizenetAim_Upgrade_0_1_0 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        ...
        Axis::single('core/config_field')
            ...
            ->add('payment/AuthorizenetAim_Standard/orderStatusId', 'Order Status on payment complete', 2, 'select', 'Set the status of orders made with this payment module to this value', array('model' => 'Axis_Sales_Model_Order_Status', 'translation_module' => 'Axis_Admin'))
            ...
            ->add('payment/AuthorizenetAim_Standard/xLogin', 'Login Id', '', 'string', 'The API Login ID used for the Authorize.net service', array('model' => 'Axis_Core_Model_Option_Crypt'))
            ->add('payment/AuthorizenetAim_Standard/xTransactionKey','Transaction Key', '', 'string', 'Transaction Key used for encrypting TP data (See your Authorizenet Account->Security Settings->API Login ID and Transaction Key for details.)', array('model' => 'Axis_Core_Model_Option_Crypt'))
