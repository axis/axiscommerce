...
class Axis_ShippingUps_Upgrade_0_1_2 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        Axis::single('core/config_field')
            ->add('shipping/Ups_Standard/showErrors', 'Display messages from service provider', 1, 'radio', '', array('model'=> 'Axis_Core_Model_Option_Boolean', 'translation_module' => 'Axis_Admin'));
    }
}
