...
class Axis_Catalog_Upgrade_0_2_3 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        ...
        Axis::single('core/config_field')
            ...
            ->add('catalog/listing/type', 'Catalog/Product Listing/Type', Axis_Catalog_Model_Product_Listing_Type::getConfigOptionDeafultValue(), 'select', 'Default listing type', array('model' => 'Axis_Catalog_Model_Product_Listing_Type'))
            ...
            ->add('catalog/lightzoom/zoomStagePosition', 'Zoomer position', Axis_Catalog_Model_Lightzoom_StagePosition::getConfigOptionDeafultValue(), 'select', '', array('model' => 'Axis_Catalog_Model_Lightzoom_StagePosition'))
            ...
            ->add('catalog/lightzoom/zoomCursor', 'Lens cursor', Axis_Catalog_Model_Lightzoom_Cursor::getConfigOptionDeafultValue(), 'select', '', array('model' => 'Axis_Catalog_Model_Lightzoom_Cursor'))
            ->add('catalog/lightzoom/zoomOnTrigger', 'Zoom on trigger', Axis_Catalog_Model_Lightzoom_DomEvent_OnTrigger::getConfigOptionDeafultValue(), 'select', 'Select none, if you wish to disable this event', array('model' => 'Axis_Catalog_Model_Lightzoom_DomEvent_OnTrigger'))
            ->add('catalog/lightzoom/zoomOffTrigger', 'Zoom off trigger', Axis_Catalog_Model_Lightzoom_DomEvent_OffTrigger::getConfigOptionDeafultValue(), 'select', 'Select none, if you wish to disable this event', array('model' => 'Axis_Catalog_Model_Lightzoom_DomEvent_OffTrigger'))
            ->add('catalog/lightzoom/lightboxTrigger', 'Lightbox trigger', Axis_Catalog_Model_Lightzoom_DomEvent_Trigger::getConfigOptionDeafultValue(), 'select', 'Select none, if you wish to disable this event', array('model' => 'Axis_Catalog_Model_Lightzoom_DomEvent_Trigger'))
            ...
            ->add('catalog/lightzoom/switchImageTrigger', 'Switch image trigger', Axis_Catalog_Model_Lightzoom_DomEvent_ImageTrigger::getConfigOptionDeafultValue(), 'select', 'Select none, if you wish to disable this event', array('model' => 'Axis_Catalog_Model_Lightzoom_DomEvent_ImageTrigger'))
            ...
            ->add('image/product/cache', 'Images/Product Images/Cache', 1, 'bool', 'Enable image cache', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ...
            ->add('image/watermark/enabled', 'Images/Watermark/Enabled', 0, 'bool', '', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ...
            ->add('image/watermark/position', 'Watermark Position', Axis_Catalog_Model_Watermark_Position::getConfigOptionDeafultValue(), 'select', array('model' => 'Axis_Catalog_Model_Watermark_Position'))
            ->add('image/watermark/opacity', 'Opacity', 50, 'string', 'Values [0 - 100]')
            ->add('image/watermark/repeat', 'Repeat', 0, 'bool', '', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'));
