...
class Axis_Catalog_Upgrade_0_2_7 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        ...
        Axis::single('admin/acl_resource')
            ...
            ->add('admin/catalog/product/simple-list')
            ...
            ->add('admin/catalog/manufacturer/batch-save')
            ...
            ->add('admin/catalog/category/get-root-categories')
            ->add('admin/catalog/category/save-image')
            ->remove('admin/catalog_')
        ;
