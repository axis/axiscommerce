...
class Axis_Community_Upgrade_0_1_0 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        ...
        Axis::single('core/config_field')
            ...
            ->add('community/review/enabled', 'Community/Reviews/Enabled', 1, 'bool', '', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ->add('community/review/rating_enabled', 'Enable ratings', 1, 'bool', 'Enable rating system in reviews', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ->add('community/review/rating_title', 'Show rating title', 1, 'bool', 'Show rating titles', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ->add('community/review/merge_average', 'Merge average ratings', 1, 'bool', 'Show average rating as one', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ...
            ->add('community/review/guest_permission', 'Allow guest to write a reviews', 1, 'bool', '', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ...
            /*->add('community/image/enabled', 'Community/Images/Enabled', 1, 'bool', 'Community images module status', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ...
            ->add('community/image/guest_permission', 'Allow guest to upload an images', 1, 'bool', '', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ->add('community/image/max_size', 'Maximum image size', '1', 'string', 'Maximum image size, allowed to upload (Mb)')
            ->add('community/video/enabled', 'Community/Videos/Enabled', 1, 'bool', 'Community video module status', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
            ...
            ->add('community/video/guest_permission', 'Allow guest to upload videos', 1, 'bool', 'Allow guest to upload videos', array('model'=> 'Axis_Core_Model_Config_Value_Boolean'))
