...
class Axis_Community_Upgrade_0_1_0 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        ...
        Axis::single('core/config_field')
            ...
            ->add('community/review/enabled', 'Community/Reviews/Enabled', 1, 'radio', '', array('model'=> 'Axis_Core_Model_Option_Boolean'))
            ->add('community/review/rating_enabled', 'Enable ratings', 1, 'radio', 'Enable rating system in reviews', array('model'=> 'Axis_Core_Model_Option_Boolean'))
            ->add('community/review/rating_title', 'Show rating title', 1, 'radio', 'Show rating titles', array('model'=> 'Axis_Core_Model_Option_Boolean'))
            ->add('community/review/merge_average', 'Merge average ratings', 1, 'radio', 'Show average rating as one', array('model'=> 'Axis_Core_Model_Option_Boolean'))
            ->add('community/review/customer_status', 'Default customer review status', Axis_Community_Model_Option_Review_Status::PENDING, 'select', 'Default review status written by registered customer', array('model' => 'Axis_Community_Model_Option_Review_Status'))
            ->add('community/review/guest_status', 'Default guest review status', Axis_Community_Model_Option_Review_Status::PENDING, 'select', 'Default review status written by guest', array('model' => 'Axis_Community_Model_Option_Review_Status'))
            ->add('community/review/guest_permission', 'Allow guest to write a reviews', 1, 'radio', '', array('model'=> 'Axis_Core_Model_Option_Boolean'))
            ...
            /*->add('community/image/enabled', 'Community/Images/Enabled', 1, 'radio', 'Community images module status', array('model'=> 'Axis_Core_Model_Option_Boolean'))
