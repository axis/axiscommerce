...
class Axis_ShippingTable_Upgrade_0_1_2 extends Axis_Core_Model_Migration_Abstract
{
    ...
    public function up()
    {
        ...
        Axis::single('core/config_field')
            ...
            ->add('shipping/Table_Standard/import', 'Import', 'shippingtable.csv', 'handler', 'File at ECART_ROOT/var/export folder, with shipping rates', array('model' => 'ShippingTableRateImport'))
            ->add('shipping/Table_Standard/export', 'Export', 'shippingtable_export.csv', 'handler', 'File will be written to ECART_ROOT/var/export folder', array('model' => 'ShippingTableRateExport'))
